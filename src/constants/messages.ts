export const messages = {
  validation: {
    ...
    conquestAlreadyExists: 'Já existe uma conquista cadastrada com este nome.',
    conquestNotFound: 'Conquista não encontrada.',
    ...
    imageInvalidType: 'Apenas imagens são permitidas (jpeg, png, webp).',
    imageUploadFailed: 'Falha ao fazer upload da imagem.',
    imageNotFound: 'Imagem não encontrada.',
    invalidCoordinates: 'Coordenadas inválidas.',
    reviewNotFound: 'Avaliação não encontrada.',
    notReviewOwner: 'Você não tem permissão para excluir esta avaliação.',
    invalidRating: 'A avaliação deve ser um número inteiro entre 1 e 5.',
