export const messages = {
  validation: {
    ...
    alreadyReportedReview: 'Você já denunciou esta avaliação.',
    cannotReportOwnReview: 'Você não pode denunciar a própria avaliação.',
    reviewReported: 'Avaliação denunciada com sucesso.',
